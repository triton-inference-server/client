...
__DEFAULT_PYTRITON_HOME = os.path.join(
    os.getenv("XDG_CACHE_HOME", "$HOME/.cache"), "pytriton"
)
__PYTRITON_HOME = os.path.expanduser(
    os.path.expandvars(os.getenv("PYTRITON_HOME", __DEFAULT_PYTRITON_HOME))
)
